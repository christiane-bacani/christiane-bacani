# Hi, I'm Christiane 👋
**Python Developer  |  Data Engineering & Analytics · Philippines 🇵🇭**
...
End-to-end data project that automatically scapes live gaming metrics from [Steam Charts Website](#https://steamcharts.com/) across Bronze-Silver-Gold Medallion Architecture for tracking trending games, top games, and peak game records. Being extended with a Power BI analytics dashboard and a game recommendation web-application system applying machine learning on processed pipeline data.
